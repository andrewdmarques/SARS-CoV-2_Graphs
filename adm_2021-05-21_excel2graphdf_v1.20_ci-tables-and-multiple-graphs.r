...
data4 <- rename(data4, c("sample_size" = "group_count", "percent_lineage" = "lineage_perc", "lower_95%_CI" = "lower_ci", "upper_95%_CI" = "upper_ci"))
...
# Graph 1: Delaware Valley All Samples
...
title <- 'Delaware Valley Random Sample SARS-CoV-2 Variants'
...
title <- 'Delaware Valley Asymptomatic SARS-CoV-2 Variants'
...
title <- 'Delaware Valley Hospitalized SARS-CoV-2 Variants'
...
title <- 'Delaware Valley Spike Drop Out SARS-CoV-2 Variants'
...
title <- 'Delaware Valley Vaccine Breakthrough SARS-CoV-2 Variants'
