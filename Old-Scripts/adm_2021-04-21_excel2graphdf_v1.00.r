...
ggplot(data2, aes(x=date, y=percentage, fill=lineage)) + geom_area(alpha=0.6 , size=.5, color="white") + scale_fill_viridis(discrete = T) + theme_ipsum() +  ggtitle("Philadelphia Random Sampling SARS-CoV-2 Variants")
